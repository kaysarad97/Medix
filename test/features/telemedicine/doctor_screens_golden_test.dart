...
///    макета не существует. В приложении лента отсчитывается от сегодняшнего
///    дня, здесь она пришпилена к 20 июля (см. FakeDoctorsRepository.fixedWeek),
///    иначе эталон расходился бы каждые сутки;
