...
/// Эталон «Настройки профиля» (врач-фрилансер) — сверка с
/// `design/врач фрилансер/Настройки Профиля.png`.
void main() {
  setUpAll(loadAppFonts);

  testWidgets('doctor_profile_settings_screen соответствует эталону', (
    tester,
  ) async {
    ...
    await expectLater(
      find.byType(DoctorProfileSettingsScreen),
      matchesGoldenFile('goldens/doctor_profile_settings_screen.png'),
    );
  });
}
