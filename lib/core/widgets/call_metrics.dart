...
/// Размеры экрана звонка — общие для пациентского и врачебного.
///
/// Лежат в `core/`, потому что понадобились второй фиче: у врача свой
/// экран звонка (`design/для врача от клиники/Видео-звонок.png`), и он
/// зеркальный — крупно пациент, в углу врач.
///
