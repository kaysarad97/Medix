...
/// в макете это подпись «изменить аватара». Своё фото не загружается:
/// снимок лица это биометрия, а её обработка по Закону РК «О персональных
/// данных» требует отдельного согласия и защищённого хранения.
///
